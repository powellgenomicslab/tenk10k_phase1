...
df3 = read.csv(paste0(samples_dir,"S0023.tsv"),sep="\t", header = F)
df4 = read.csv(paste0(samples_dir,"S0024.tsv"),sep="\t", header = F)
...
df3 = read.csv(paste0(samples_dir,"S0027.tsv"),sep="\t", header = F)
df4 = read.csv(paste0(samples_dir,"S0028.tsv"),sep="\t", header = F)
df5 = rbind(df1,df2,df3,df4)
colnames(df5) <- c()
out_file = paste0(samples_dir, maxi_pool, ".tsv")
fwrite(df5, out_file, sep="\t")
...
df3 = read.csv(paste0(samples_dir,"S0032.tsv"),sep="\t", header = F)
df4 = read.csv(paste0(samples_dir,"S0033.tsv"),sep="\t", header = F)
df5 = rbind(df1,df2,df3,df4)
colnames(df5) <- c()
out_file = paste0(samples_dir, maxi_pool, ".tsv")
fwrite(df5, out_file, sep="\t")
