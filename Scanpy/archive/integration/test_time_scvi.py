...
data = {"nsamples": numbers_to_combine, "ncells": 0, "ngenes": 0, "concat_time": 0, "pca_time": 0, "scvi_time": 0}
summary_df = pd.DataFrame(data)
summary_filename = "/share/ScratchGeneral/anncuo/tenk10k/data_processing/integration/scvi_etal_times_summary.csv"
...
for num in numbers_to_combine:
    ...
    start_time = time.time()
    model.train()
    summary_df.at[rowIndex,'scvi_time'] = time.time() - start_time
