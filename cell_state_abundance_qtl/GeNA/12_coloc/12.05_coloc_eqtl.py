...
if __name__ == "__main__":
    ...
    # egenes_files_path = '/directflow/SCCGGroupShare/projects/anncuo/TenK10K_pilot/tenk10k/eqtl_results/saige_qtl/december24_freeze/'
    # celltype_csaqtl = 'Monocyte'
    # celltype_eqtl = 'CD14_Mono'
    # csaqtl_file_path = '/directflow/SCCGGroupShare/projects/blabow/tenk10k_phase1/data_processing/csa_qtl/output/coloc/plink_fixed_pheno/Monocyte/gwas_local_12_69350234_cis.spheno_12_69350234.glm.linear'
    # common_maf_threshold = 0.05
    # fdr_threshold = 0.05
    # outdir = "/directflow/SCCGGroupShare/projects/blabow/tenk10k_phase1/data_processing/csa_qtl/output/coloc/coloc_results/Monocyte/eqtl"
    # cis_window = 100000
    ...
    # # This gives the list of significant egenes to coloc with
    ...
    # # Filter eQTL results to include only SNPs within cis region around csaQTL lead-snp and only significant egenes
    # eqtl_results_cis_egenes = eqtl_results_all_snps.loc[
    #     (eqtl_results_all_snps["chr"] == f"chr{chr}")
    #     & (eqtl_results_all_snps["position"] > pos - cis_window)
    #     & (eqtl_results_all_snps["position"] < pos + cis_window)
    ...
    # # filter it based on gene list above
