...
plot_gene_locuszoom <- function(gene, sumstats_csaqtl, sumstats_gwas, gwas_pheno_name, sumstats_eqtl, celltype, minor_cell_types = NULL, ct_pval_thresholds, tenk_color_pal, resolution = "major_cell_types", analysis_name = "no_expr_pc_covars") {
    out_dir <- glue("/directflow/SCCGGroupShare/projects/blabow/tenk10k_phase1/data_processing/csa_qtl/figures/{resolution}/locuszoomR/coloc")
