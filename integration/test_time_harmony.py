...
data = {"nsamples": numbers_to_combine, "ncells": 0, "ngenes": 0, "concat_time": 0, "pca_time": 0, "harmonypy_time": 0}
summary_df = pd.DataFrame(data)
summary_filename = "/share/ScratchGeneral/anncuo/tenk10k/data_processing/integration/harmonypy_etal_times_summary.csv"
...
for num in numbers_to_combine:
    ...
    start_time = time.time()
    sce.pp.harmony_integrate(adata_all, 'sample')
    summary_df.at[rowIndex,'harmonypy_time'] = time.time() - start_time
